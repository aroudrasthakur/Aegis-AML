...
_STUB_DEFS: list[tuple[int, str, list[str], str, list[str]]] = [
    ...
    (147, "MerchantProcessorOfframp", ["offramp"],
     "Off-ramping through complicit merchant payment processors.", ["merchant_data"]),
    (148, "OTCSettlementTradeInvoices", ["offramp"],
    ...
    (152, "InvoiceFinancingOfframp", ["offramp"],
     "Using invoice financing platforms to off-ramp crypto.", ["invoice_data"]),
    (153, "RealEstateDownPaymentExchange", ["offramp"],
    ...
    (177, "MerchantTradeSettlementCrypto", ["offramp"],
